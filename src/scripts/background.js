// Background scripts to be run during any browser usage.
// Note: the popup does not need to be open for these scripts to be run.
...
chrome.tabs.onUpdated.addListener(function(tabId, changeInfo, tab){
    getBiasRatings().then(current_json => {
        if(changeInfo.url){
            ...
            //check that current tab is not the home page of website
            if(trimmedURLPart2 !== ""){
