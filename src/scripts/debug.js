...
async function test_scraper() {
  ...
  async function makeGetRequest(url){
    ...
    pages.forEach(function(page) {
      ...
      // alert((htmlDoc.getElementsByTagName( 'source-title' ).parentNode.firstChild.nextSibling.firstChild.nextSibling.firstChild.nodeValue));
        
    
        var dataObj = {title: null, rating: null, url: null};
    
        htmlDoc.getElementsByClassName( 'source-title' ).each(function(i, element) {
          ...
          makeGetRequest(pageLink).then(queryResult => {
            // if (error) throw new Error(error);
              var ef = document.createElement( 'html' );
              ef.innerHTML = queryResult;
          
              ef.getElementsByClassName( 'source-title' );
    
              ef.getElementsByTagName( 'a' ).each(function (i, element) {
                try {
